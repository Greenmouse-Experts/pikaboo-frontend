...
import { useLazyGetWasteOneScheduleQuery } from "@/services/api/scheduleSlice";
...
const ScheduleDetails: AppPage = () => {
  ...
  const zone = useAppSelector((state) => state.user.user.zone.name)
  const [getItem] = useLazyGetWasteOneScheduleQuery();
        ...
        <div>
          <div className="p-5 flex items-center justify-between">
            <div>
              ...
              <p className="fw-600 text-2xl">{zone}</p>
              <p className="fw-500">
