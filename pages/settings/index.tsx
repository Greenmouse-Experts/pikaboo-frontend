...
import { useLazyUpdateUserPhotoQuery } from '@/services/api/authSlice';
...
import UpdateProfileFormUsers from '@/shared/components/settings/UpdateProfileUser';
import ChangeAdminPasswordUsers from '@/shared/components/settings/ChangePasswordFormUsers';


const UsersSettingsPage:AppPage = () => {
    ...
    const [upload] = useLazyUpdateUserPhotoQuery();
    ...
    return (
      <>
        ...
        <UpdateProfile title="Update Profile">
          <UpdateProfileFormUsers close={() => setShowUpdateProfile(false)}/>
        </UpdateProfile>
        <ChangePassword title="Change Password">
            <ChangeAdminPasswordUsers close={() => setShowChangePassword(false)}/>
        </ChangePassword>
      </>
    );
}
...
UsersSettingsPage.Layout = 'Dashboard'