...
import WasteManagerTruck from "@/shared/components/admin/staff/waste/WasteManagerTruck";
import WasteManagerZone from "@/shared/components/admin/staff/waste/WasteManagerZone";
    ...
    <>
      <div>
        ...
        <div className="mt-8">
          ...
          <div className="">
            {
              open === 1?  <WasteManagerZone/> : ""
            }
            {
              open === 2? <WasteManagerTruck/> : ""
            }
          </div>
        </div>
      </div>
