  ...
  return (
    <div className="flex ">
      ...
      <div className="w-full fixed bg-white index-30 px-3 top-2">
        <div className="dash-head-shade p-3 h-[9vh] rounded-lg">
          <div className="flex items-center gap-x-12">
            ...
            <div className="flex w-4/12 md:w-full justify-end lg:justify-between items-center">
              <div className="hidden lg:flex gap-x-2 items-center">
                ...
                <FaRegThumbsUp className="text-[#ffcc33]"  onClick={() => setToggled(!toggled)}/>
              </div>
              <div className="flex justify-between gap-x-4 items-center">
                ...
                <div className="flex items-center gap-x-1">
                  ...
                  />
                  <p className="fw-500 fs-500 hidden lg:block">Victor Chigozie</p>
                </div>
              </div>
            </div>
          </div>
