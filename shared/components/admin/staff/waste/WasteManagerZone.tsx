...
import WasteManagerTable from './WasteManagerTable';
import AddWasteManagerForm from './AddWasteManager';
import ZoneAddWasteManagerForm from './AddWasteManagerZone';

const WasteManagerZone = () => {
    const [open, setOpen] = useState<number>(1);
    const {data, refetch, isLoading} = useGetUsersQuery("Waste Manager Zone")
    ...
    <>
        <div className="p-5 lg:p-9 dash-shade rounded-lg">
            ...
            <ul className="flex items-center gap-x-6">
              ...
              onClick={() => handleOpen(1)}>
                <div className="flex kitems-center gap-x-2">
                  ...
                  <p className="fw-500">Zone Managers Listing</p>
                </div>
              </li>
              ...
              onClick={() => handleOpen(2)}>
                <div className="flex kitems-center gap-x-2">
                  ...
                  <p className="fw-500">Add New Zone Manager</p>
                </div>
              </li>
            </ul>
          </div>
          <div className="mt-5">
            ...
            {
              open === 2? <ZoneAddWasteManagerForm refetch={refetch}/> : ""
            }
          </div>
        </div>
    </>
...
export default WasteManagerZone